...
export function UploadCard({
  ...
  /** Shows "N. " before the title, to mark this card as one step in an ordered flow. */
  stepNumber?: number;
  /** Label for an optional guide link shown next to the upload button. */
  guideLabel?: string;
  /** Opens the import guide modal. Required together with guideLabel. */
  onGuide?: () => void;
